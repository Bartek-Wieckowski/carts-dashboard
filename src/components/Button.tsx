...
const Button = ({ children, btnStyles, disabled, to, type, onClick }: ButtonProps) => {
  ...
  if (onClick) {
    return (
      <button type={type} onClick={onClick} disabled={disabled} className={`${styles[btnStyles]} ${isDisabledlClasses}`}>
        {children}
      </button>
    );
  }
...
const styles = {
  btnAdd:
    commonButtonClasses + ' bg-purple-700 text-white hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900',
  btnEdit: commonButtonClasses + ' text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
  btnUpdate:
    commonButtonClasses + ' bg-green-700 text-white hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800',
  btnCancel:
    commonButtonClasses +
  ...
  btnDelete: commonButtonClasses + '  text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900',
  btnQty:
